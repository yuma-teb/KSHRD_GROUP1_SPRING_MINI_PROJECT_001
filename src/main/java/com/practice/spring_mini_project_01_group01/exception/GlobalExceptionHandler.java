...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleConflictExceptions(RuntimeException ex, WebRequest request) {
        ProblemDetail problemDetail = createProblemDetail(HttpStatus.CONFLICT, ex.getMessage(), request);
    ...
    public ProblemDetail handleGenericBadRequestExceptions(RuntimeException ex, WebRequest request) {
        ProblemDetail problemDetail = createProblemDetail(HttpStatus.BAD_REQUEST, ex.getMessage(), request);
    ...
    public ProblemDetail handleNotFoundException(NotFoundException ex, WebRequest request) {
        ProblemDetail problemDetail = createProblemDetail(HttpStatus.NOT_FOUND, ex.getMessage(), request);
    ...
    public ProblemDetail handleAccessDeniedException(AccessDeniedException ex, WebRequest request) {
        ProblemDetail problemDetail = createProblemDetail(HttpStatus.FORBIDDEN, "You do not have permission to access this resource.", request);
    ...
    public ProblemDetail handleExpiredJwtException(ExpiredJwtException ex, WebRequest request) {
        ProblemDetail problemDetail = createProblemDetail(HttpStatus.UNAUTHORIZED, "Your session has expired. Please log in again.", request);
    ...
    public ProblemDetail handleMethodArgumentNotValid(MethodArgumentNotValidException ex, WebRequest request) {
        ProblemDetail problemDetail = createProblemDetail(HttpStatus.BAD_REQUEST, "Validation failed. Please check your input.", request);
