...
public class BookmarkController {
    ...
    public ResponseEntity<CustomResponse<BookmarkResponse>> addBookmarkByArticleId(@PathVariable("article_id") @Positive Long article_id){
    ...
    public ResponseEntity<CustomResponse<List<BookmarkResponse>>> getAllBookmarksByCurrentUser(
        ...
        return ResponseEntity.ok().body(bookmarkService.getAllBookmarksByCurrentUser(page,size,direction));
    }

    @DeleteMapping("/{article_id}")
    @Operation(summary = "Delete bookmark on article")
    public ResponseEntity<CustomResponse<Void>> deleteBookmarkByArticleId(@PathVariable("article_id") @Positive Long article_id){;
